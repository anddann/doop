...
public class ReuseSceneMain {
  ...
  public static void produceFacts(SootParameters sootParameters) throws Exception {
    ...
    if (sootParameters._android) {
      ...
      if (sootParameters._runFlowdroid) {
        ...
        String filename =
            ReuseSceneMain.class.getClassLoader().getResource("SourcesAndSinks.txt").getFile();
        // FIXME: adann no clue
    ...
    classes = new HashSet<>(Scene.v().getClasses());
  ...
  public static void retrieveAllSceneClassesBodies() {
    ...
    while (clIt.hasNext()) {
      ...
      if (cl.resolvingLevel() < SootClass.SIGNATURES && (cl instanceof SootModuleInfo)) continue;
